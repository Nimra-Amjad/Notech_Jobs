            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value!.isEmpty ||
                                _jobdescontroller.text.trim().isEmpty) {
                              return "* Required";
                            }
                            return null;
                          },
                  ...
                  Container(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value!.isEmpty ||
                                _yearsrequiredcontroller.text.trim().isEmpty) {
                              return "* Required";
                            }
                            return null;
                          },
                  ...
                  widget.user!.mcqs == null
                      ? CustomText(text: "No mcqs added")
                      : Container(
                          child: ListView.builder(
                            shrinkWrap: true,
